...
db.insert("4 GB DDR Ram", "John Doe", "Microcenter", "160")
db.insert("Asus Motherboard", "Roberto Gianotto", "Microcenter", "350")
db.insert("GTX 1650 Max Q", "Roberto Gianotto", "Nvidia", "220")
